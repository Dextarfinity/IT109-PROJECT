  ...
  >
    ...
    <div class="pt-24">
      ...
      >
        <!--Left Col-->
        <div
          class="flex flex-col w-full md:w-3/5 justify-center items-start text-center md:text-left px-12"
        >
          <h1
            class="my-20 text-3xl font-bold leading-none md:text-5xl lg:text-5xl xl:text-5xl"
          >
        ...
        <!--Right Col-->
        <div class="w-full md:w-2/5 py-6 text-center mb-8">
    ...
    <section class="bg-white border-b py-8">
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="w-full mb-4">
          <div
            class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t mb-8"
          ></div>
        </div>
    ...
    <section class="container mx-auto text-center py-6">
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          <!-- Left Column: Text Content -->
          <div class="w-full sm:w-1/2 p-6 text-start mt-6">
            <!-- First Row: User Interface Description -->
