<template>
    <div class="relative w-full h-screen overflow-hidden">
        ...
        <div
            class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center bg-white authbody min-h-100"
        >
            <!--Left Col-->
                ...
                >
                    ...
                    <div id="login-form" class="form-slide">
                        ...
                        <p class="text-center text-black pt-6 pb-4">
                            Put Your Registered Email And You'll Receive An
                            Email:
                        </p>
                        <form
