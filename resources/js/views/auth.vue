        ...
        >
            <defs>
                <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <stop
                        offset="100%"
                        style="stop-color: #daae51; stop-opacity: 1"
                    />
                </linearGradient>
            </defs>
            <!-- Flip the SVG both vertically and horizontally by scaling x and y to -1 -->
            <g transform="scale(-1, -1) translate(-1428, -174)">
                <g
                    stroke="none"
                    stroke-width="1"
                    fill="none"
            ...
            >
                ...
                >
                    ...
                    <div id="login-form" class="form-slide">
                        <h2
                            class="text-center text-4xl font-extrabold text-black"
                        >
                            WELCOME
                        </h2>
                        <p class="text-center text-black pt-6 pb-4">
                        ...
                        >
                            ...
                            <div class="text-center mt-4">
                                <button
                                    ...
                                    class="w-full py-2 px-4 bg-white border border-gray-300 hover:bg-gray-100 rounded-md shadow-lg text-black font-semibold transition duration-200 flex items-center justify-center"
                                    type="button"
                                >
                                    <img
                    ...
                    <div id="signup-form" class="form-slide">
                        ...
                        <p class="text-center text-black pt-6 pb-4">
                            Create your account, Fill up the following:
                        </p>
                        <form
                        ...
                        >
                            <div class="relative">
                                ...
                                />
                                <p id="nameError" class="text-red-500">
                                    {{ nameError }}
                                </p>
                                <label
                            ...
                            <div class="relative">
                                ...
                                />
                                <p id="passwordError" class="text-red-500">
                                    {{ passwordError }}
                                </p>
                                <label
                                    class="font-bold absolute left-0 -top-3.5 text-black text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-black peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-black peer-focus:text-sm"
    ...
    methods: {
        ...
        async handleGoogleSignIn() {
            try {
                ...
                // Show success toast on Google login
        ...
        validateNumber() {
            try {
                ...
                if (error.message === "Empty-number") {
                    this.numberError =
                        "Number field is empty. Please enter your number.";
        ...
        validatePassword() {
            try {
                ...
                if (!/[A-Z]/.test(this.password))
                    throw new Error("noUppercase");
                if (!/[a-z]/.test(this.password))
                    throw new Error("noLowercase");
        ...
        async handleSubmit(formType) {
            if (formType === "login") {
                if (this.loginEmail && this.loginPassword) {
                    ...
                    this.showToast(
                        "Please fill in all fields for login.",
                        "error"
                    );
                }
                ...
                if (
                    ...
                    try {
                        ...
                        if (!user_id)
                            throw new Error(
                                "Failed to get user ID during signup"
                            );
...
.divider-line {
    width: 100%;
    border: none;
    border-top: 3px solid #ccc; /* Adjust color as needed */
    margin: 10px 0;
}
...
svg {
    ...
    z-index: 10; /* Optional: To ensure it stays on top of other elements */
}
.body_sign_in {
